    ...
    <Layout>
      ...
      <div className="description">
        <p>
          ...
          with the following code of conduct. Organizers will enforce this code throughout the
        ...
        <p>
          ...
          identified as they will be wearing branded clothing and/or badges.
        </p>
        <p>
        ...
        <p>
          ...
          conference-related social events. Failure to comply will result in your removal from the
          conference venue and could result in a ban from future events.
        </p>
        <p>
          <strong>
