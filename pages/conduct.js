  ...
  return (
    <Layout>
      ...
      <div className="description">
        ...
        <p>Participants asked to stop any harassing behavior are expected to comply <strong>immediately</strong>.</p>
        ...
        <p><strong>If a participant engages in harassing behavior, the conference organizers may take any action they deem appropriate, including warning the offender or expulsion from the conference with no refund.</strong></p>
        ...
        <p>We expect participants to follow these rules at conference and workshop venues and conference-related social events. Failure to comply will result in your removal from the conference venue and could result in a ban from future events.</p>
        <p><strong>If you notice any violation of the code of conduct, please report it to <a href="mailto:conduct@magnoliajs.com">Kayla Sween</a> immediately.</strong></p>
        <p><em>This code of conduct was borrowed from <a href="https://confcodeofconduct.com">Conference Code of Conduct</a>.</em></p>
      </div>
    </Layout >
  )
}
