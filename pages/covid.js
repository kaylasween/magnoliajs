  ...
  return (
    <Layout>
      ...
      <div className="description">
        ...
        <p>The safety of our attendees, volunteers, speakers, staff, and sponsors are of the utmost priority. We will be continuously updating this policy, so keep an eye on this page and <a href="https://twitter.com/magnoliajsconf">our Twitter account</a> for updates.</p>
        <h2>Vaccinations</h2>
